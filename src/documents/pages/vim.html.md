---
title: ".Vim"
intro: Vim configration for the lazy
layout: page
tags: ['vim']
pageOrder: 99
---
...
8. Adds line numbers.
9. Adds the ability to have .vimrc configuration per directories
...
- [Easy Motion](https://github.com/Lokaltog/vim-easymotion) - This also replaces generic searching
...
- [taglist](https://github.com/vim-scripts/taglist.vim) - This is mapped to &lt;F3&gt;
